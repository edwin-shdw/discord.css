...
<CodePreview>
  <Mention role color='#f47fff'>@Server Booster</Mention>
</CodePreview>

```html
<span class="dc-mention dc-mention-role" style="--dc-mention-color-rgb: 244 127 255">
    @Server Booster
</span>
```

Role mentions will increase their opacity on hover, that's why you need to pass the RGB values to the
`--dc-mention-color` variable, separated by a whitespace. If you are using a frontend framework like [React](https://react.dev/) you could simply
